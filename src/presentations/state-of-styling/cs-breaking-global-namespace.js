...
const images = {
  ...
  sponsors: require('../../assets/cs_sponsor.jpg'),
    ...
    return (
      ...
      >
        ...
        <Slide transition={['zoom']} bgColor="primary">
          ...
          <Link
            href="https://slides.krwelch.com/cs-breaking-css-global-namespace"
            margin=".5rem 0 0"
            textColor="tertiary"
            size={0.75}
            italic
          >
            https://slides.krwelch.com/cs-breaking-css-global-namespace
          </Link>
